    ...
    : DocumentWindow("Document Window", Colours::darkgreen, DocumentWindow::allButtons)
{
    ...
    _labelTexturePng->setBounds (0, 32, 150, 24);
    ...
    _textEditorTexturePng->setBounds (179, 32, 460, 24);
    ...
    _textButtonTexturePng->setBounds (724, 32, 150, 24);
    ...
    _textButtonxmlSheet->setBounds (724, 0, 150, 24);
    ...
    _textEditorxmlSheet->setBounds (179, 0, 460, 24);
    ...
    _labelXmlSheet->setBounds (0, 0, 150, 24);
    ...
    _textButtonParticleFragment->setBounds (724, 69, 150, 24);
    ...
    _textEditorParticleFragment->setBounds (179, 64, 460, 24);
    ...
    _labelParticleFragment->setBounds (0, 69, 150, 24);
    ...
    _textButtonParticleVetex->setBounds (724, 96, 150, 24);
    ...
    _textEditorParticleVetex->setBounds (179, 96, 460, 24);
    ...
    _labelParticleVetex->setBounds (0, 104, 150, 24);
    ...
    _textButtonstaffFragment->setBounds (724, 136, 150, 24);
    ...
    _textEditorstaffFragment2->setBounds (179, 134, 460, 24);
    ...
    _labelstaffFragment->setBounds (0, 134, 150, 24);
    ...
    _textButtonstaffVetex->setBounds (724, 168, 150, 24);
    ...
    _textEditorstaffVetex->setBounds (179, 169, 460, 24);
    ...
    _labelstaffVetex->setBounds (0, 169, 150, 24);
    ...
    _textButtonTieFragment2->setBounds (724, 208, 150, 24);
    ...
    _textEditorTieFragment3->setBounds (179, 206, 460, 24);
    ...
    _labelTieFragment->setBounds (0, 206, 150, 24);
    ...
    _textButtonTieVetex->setBounds (724, 249, 150, 24);
    ...
    _textEditorTieVetex->setBounds (179, 249, 460, 24);
    ...
    _labelTieVetex2->setBounds (0, 249, 150, 24);
    ...
    _difficulty->setBounds (0, 616, 150, 24);
    ...
    _textEditorDifficulty->setBounds (179, 616, 160, 24);
    ...
    _textEditorType->setBounds (179, 656, 160, 24);
    ...
    _textEditorTitle->setBounds (179, 704, 503, 24);
    ...
    _Author->setBounds (0, 749, 150, 24);
    ...
    _textEditorAuthor->setBounds (179, 749, 700, 24);
    ...
    _Picture->setBounds (0, 790, 150, 24);
    ...
    _textEditorPicture->setBounds (179, 790, 700, 24);
    ...
    juce__label->setBounds (0, 288, 150, 24);
    ...
    juce__label2->setBounds (0, 328, 150, 24);
    ...
    _textEditorTimeFrag->setBounds (179, 288, 460, 24);
    ...
    _textEditorTimeVetex->setBounds (179, 328, 460, 24);
    ...
    juce__label3->setBounds (0, 360, 150, 24);
    ...
    juce__label4->setBounds (0, 400, 150, 24);
    ...
    _textEditorBackGroundFragment->setBounds (179, 368, 460, 24);
...
<JUCER_COMPONENT documentType="Component" className="BinGeneratorComponent" componentName=""
  ...
  <BACKGROUND backgroundColour="ff323e44">
    <IMAGE pos="764 324 316 276" resource="" opacity="1.0" mode="0"/>
  </BACKGROUND>
  ...
  <TEXTBUTTON name="_openParticleFragment" id="63d8fd3e8952293" memberName="_textButtonParticleFragment"
              virtualName="" explicitFocusOrder="0" pos="724 69 150 24" buttonText="open"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTEDITOR name="ParticleFragment" id="59b14c8ae5fda44e" memberName="_textEditorParticleFragment"
              virtualName="" explicitFocusOrder="0" pos="179 64 460 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="ParticleFragment" id="ce839e0227766d97" memberName="_labelParticleFragment"
         virtualName="" explicitFocusOrder="0" pos="0 69 150 24" edTextCol="ff000000"
  ...
  <TEXTBUTTON name="_openParticleVetex" id="27680997b515b97f" memberName="_textButtonParticleVetex"
              virtualName="" explicitFocusOrder="0" pos="724 96 150 24" buttonText="open"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTEDITOR name="ParticleVetex" id="7d6ed9ebe0c6a94e" memberName="_textEditorParticleVetex"
              virtualName="" explicitFocusOrder="0" pos="179 96 460 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="ParticleVetex" id="bd0c1bbbf0971c22" memberName="_labelParticleVetex"
         virtualName="" explicitFocusOrder="0" pos="0 104 150 24" edTextCol="ff000000"
  ...
  <TEXTBUTTON name="_openstaffFragment" id="fdbb90a7e463f5c2" memberName="_textButtonstaffFragment"
              virtualName="" explicitFocusOrder="0" pos="724 136 150 24" buttonText="open"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTEDITOR name="staffFragment" id="89d6efd204450ea0" memberName="_textEditorstaffFragment2"
              virtualName="" explicitFocusOrder="0" pos="179 134 460 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="staffFragment" id="f6d4e2dbf5a84c10" memberName="_labelstaffFragment"
         virtualName="" explicitFocusOrder="0" pos="0 134 150 24" edTextCol="ff000000"
  ...
  <TEXTBUTTON name="_openstaffVetex" id="2293d53ddcdc496" memberName="_textButtonstaffVetex"
              virtualName="" explicitFocusOrder="0" pos="724 168 150 24" buttonText="open"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTEDITOR name="staffVetex" id="8a3fc2adfb5d8e77" memberName="_textEditorstaffVetex"
              virtualName="" explicitFocusOrder="0" pos="179 169 460 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="staffVetex" id="9e9223961494bdf8" memberName="_labelstaffVetex"
         virtualName="" explicitFocusOrder="0" pos="0 169 150 24" edTextCol="ff000000"
  ...
  <TEXTBUTTON name="_openTieFragment" id="75ee31e2d4714000" memberName="_textButtonTieFragment2"
              virtualName="" explicitFocusOrder="0" pos="724 208 150 24" buttonText="open"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTEDITOR name="TieFragment" id="22882ca1c86950d" memberName="_textEditorTieFragment3"
              virtualName="" explicitFocusOrder="0" pos="179 206 460 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="TiefFragment" id="5753dea5002b258b" memberName="_labelTieFragment"
         virtualName="" explicitFocusOrder="0" pos="0 206 150 24" edTextCol="ff000000"
  ...
  <TEXTBUTTON name="_openTieVetex" id="aa57d4730aee5fe3" memberName="_textButtonTieVetex"
              virtualName="" explicitFocusOrder="0" pos="724 249 150 24" buttonText="open"
              connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <TEXTEDITOR name="TieVetex" id="fb24e9bc42dace0e" memberName="_textEditorTieVetex"
              virtualName="" explicitFocusOrder="0" pos="179 249 460 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="TieVetex" id="42bbac015cf07f06" memberName="_labelTieVetex2"
         virtualName="" explicitFocusOrder="0" pos="0 249 150 24" edTextCol="ff000000"
  ...
  <LABEL name="difficulty" id="975da7d42a07b022" memberName="_difficulty"
         virtualName="" explicitFocusOrder="0" pos="0 616 150 24" edTextCol="ff000000"
         edBkgCol="0" labelText="difficulty&#10;" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15.0" kerning="0.0" bold="0" italic="0" justification="33"/>
  <TEXTEDITOR name="textofdifficulty" id="7abc5f97c4094e4" memberName="_textEditorDifficulty"
              virtualName="" explicitFocusOrder="0" pos="179 616 160 24" initialText="1"
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="Type" id="3e578a153c9af6a9" memberName="_Type" virtualName=""
         explicitFocusOrder="0" pos="0 656 150 24" edTextCol="ff000000"
  ...
  <TEXTEDITOR name="textofType" id="f50678b186f1d9ce" memberName="_textEditorType"
              virtualName="" explicitFocusOrder="0" pos="179 656 160 24" initialText="CLASSICAL"
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="Title" id="bd43d19baed8f55c" memberName="_Title" virtualName=""
         explicitFocusOrder="0" pos="1 701 150 24" edTextCol="ff000000"
  ...
  <TEXTEDITOR name="textofTitle" id="c5f4daa5f43c9f7f" memberName="_textEditorTitle"
              virtualName="" explicitFocusOrder="0" pos="179 704 503 24" initialText="Title..."
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="Author" id="91618ead3e06ab8a" memberName="_Author" virtualName=""
         explicitFocusOrder="0" pos="0 749 150 24" edTextCol="ff000000"
  ...
  <TEXTEDITOR name="textofAuthor" id="bc8f74d41e43ea02" memberName="_textEditorAuthor"
              virtualName="" explicitFocusOrder="0" pos="179 749 700 24" initialText="Author..."
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="Picture" id="6f9bf486e7bc944a" memberName="_Picture" virtualName=""
         explicitFocusOrder="0" pos="0 790 150 24" edTextCol="ff000000"
  ...
  <TEXTEDITOR name="textofPicture" id="22222ffa3ed56b97" memberName="_textEditorPicture"
              virtualName="" explicitFocusOrder="0" pos="179 790 700 24" initialText="&#10;"
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  ...
  <LABEL name="new label" id="da775e71f549b583" memberName="juce__label"
         virtualName="" explicitFocusOrder="0" pos="0 288 150 24" edTextCol="ff000000"
         edBkgCol="0" labelText="TimeQuardFragment&#10;" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15.0" kerning="0.0" bold="0" italic="0" justification="33"/>
  <LABEL name="new label" id="737d10b40e887cc4" memberName="juce__label2"
         virtualName="" explicitFocusOrder="0" pos="0 328 150 24" edTextCol="ff000000"
  ...
  <TEXTEDITOR name="new text editor" id="be45388e233227e0" memberName="_textEditorTimeFrag"
              virtualName="" explicitFocusOrder="0" pos="179 288 460 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <TEXTEDITOR name="new text editor" id="97f8435b0fb4ea8d" memberName="_textEditorTimeVetex"
              virtualName="" explicitFocusOrder="0" pos="179 328 460 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
  <LABEL name="new label" id="8e12ec90409cf2e8" memberName="juce__label3"
         virtualName="" explicitFocusOrder="0" pos="0 360 150 24" edTextCol="ff000000"
  ...
  <LABEL name="new label" id="9e37c81fb857aa84" memberName="juce__label4"
         virtualName="" explicitFocusOrder="0" pos="0 400 150 24" edTextCol="ff000000"
  ...
  <TEXTEDITOR name="new text editor" id="a2a1d9ddc3677763" memberName="_textEditorBackGroundFragment"
              virtualName="" explicitFocusOrder="0" pos="179 368 460 24" initialText=""
              multiline="0" retKeyStartsLine="0" readonly="0" scrollbars="1"
              caret="1" popupmenu="1"/>
